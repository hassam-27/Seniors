...
import PasswordReset from "./Compnents/resetPassword/index";
import ForgetPassword from "./Compnents/forgetPassword/index";
import Complain from "./Compnents/Seller/Complain"
import RegisterComplain from "./Compnents/RegisterComplain/registerComplain";
  ...
  return (
    <>
      ...
      <BrowserRouter>
        ...
        <Header />
        <Routes>
        <Route exact path="/forget-password" element={<ForgetPassword user="customer"/>} />
          <Route exact path="/userpassword/reset/:token" element={<PasswordReset user="customer"/>} />
          <Route
            exact
            path="/"
            element={<Body login={custLogin} setLogin={setCustLogin} />}
          />
          ...
          <Route exact path="/viewcomplain" element={<Complain user="customer" />} />
          <Route exact path="/registercomplain" element={<RegisterComplain/>} />
          ...
          <Route exact path="/Cforget-password" element={<ForgetPassword user="seller"/>} />
          <Route exact path="/sellerpassword/reset/:token" element={<PasswordReset user="seller"/>} />
          <Route
            path="/seller"
          ...
          >
            ...
            <Route exact path="viewcomplain" element={<Complain user="seller" />} />
            <Route
              exact
          ...
          <Route
            exact
            path="/result/productHub"
            element={<ProductHub login={custLogin} setLogin={setCustLogin} />}
          />
          <Route
            exact
            path="/compare"
            element={<CompareTable login={custLogin} setLogin={setCustLogin} />}
          />
        </Routes>
        <Footer />
      </BrowserRouter>
