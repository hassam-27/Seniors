      ...
      <nav className="navbar" style={{ backgroundColor: "white" }}>
        <div style={{ marginLeft: "10px" }}>
          ...
          >
            ...
            <h2 style={{ fontFamily: "sans-serif" }}>Economico</h2>
          </Link>
        </div>
        ...
        <div style={{ marginLeft: "200px" }}>
          <div class="right-links float-right mr-3">
            <div className="items">
              <div className="item">
              {(userLoggedin && !sellLogin ) && (<a style={{backgroundColor:"orange", fontSize:"15px"}} href="/registercomplain" target="_blank"  class="btn">
            Register Complain &#187;
          </a>)}
              </div>
              <a
